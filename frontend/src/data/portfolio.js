...
export const PROFILE = {
  name: "Rahul Gupta",
  role: "Data Analyst | Business Analyst | MIS Executive",
  tagline: "Transforming Data into Actionable Insights",
  heroLines: ["Transforming Data", "into Actionable", "Insights."],
  description:
    "I analyze data, build dashboards, automate workflows, and transform raw data into meaningful business insights.",
  typing: [
    "I analyze data.",
    "I build dashboards.",
...
export const ABOUT = {
  chapters: [
    ...
    },
    {
      no: "03",
      title: "Vision",
      body: "I'm deeply interested in Business Intelligence, Automation, and AI. My goal is to build systems that don't just report the past, but help teams anticipate and act on what's next.",
    },
  ],
  marquee: ["DATA DRIVEN", "INSIGHTS", "AUTOMATION", "DASHBOARDS", "BUSINESS INTELLIGENCE", "AI"],
};
